...
- The account menu is available on both the compact app bar and desktop sidebar. Choosing `退出登录` clears the locally saved administrator session token and returns the panel to the login screen.
